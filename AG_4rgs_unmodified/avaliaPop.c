...
------------------------------------------------------------------------------*/
     ...
     int i, j, k, loop_np, loop_tp, soma, lastP;
          ...
          for(loop_np = 0; loop_np<np-1; loop_np++){
               ...
               switch(pop[loop_tp][loop_np]){
                    ...
                    case 1://Combinação de regra ONE------------------------------------------------------------------------//
                         ...
                         if(loop_np>0){
                         //funcao de saida 1
                              nmov = frs1(np, tamD, col, row, pop, D, M, loop_np, nmov);
                              value = value + nmov;
                              //printf("\nvalue saida = %i", value);
                              //------------
                              //printf("\n\nMATRIZ DE OCUPACAO");
                         ...
                         //funcao de entrada 1
                         fre1(np, tamD, col, row, pop, D, M, loop_np);
                         for(i=0; i<tamD; i++){
                    ...
                    case 2://Combinação de regra TWO------------------------------------------------------------------------//
                         ...
                         if(loop_np>0){
                         //funcao de saida 2
                              nmov = frs2(np, tamD, col, row, pop, D, M, loop_np, nmov);
                              value = value + nmov;
                              //printf("\nvalue saida = %i", value);
                              //----------
                              //printf("\n\nMATRIZ DE OCUPACAO");
                    ...
                    case 3://Combinação de regra THREE----------------------------------------------------------------------//
                         ...
                         //funcao de entrada 2
                         fre2(np, tamD, col, row, pop, D, M, loop_np);
                         for(i=0; i<tamD; i++){
                              soma = soma + D[loop_np][i];
                         }
                         value = value + soma;
