...
int frs2(int np, int tamD, int col, int row, int pop[][np], int D[][tamD], int M[][col], int loop_np, int nmov);
...
int main(){
    ...
    tp = 10;//tamanho da populacao
    mut = 15;//por cento de mutacao
    cross = 90;//por cento de cruzamento
    gerac = 1;//numero de geracoes
